...
export function LogInForm() {
  ...
  return (
    <form
      ...
      className="w-md bg-[#0d1219] rounded-2xl border border-[#1e2733] p-8 shadow-2xl"
    >
      ...
      <div className="mt-4 flex flex-col gap-4">
        ...
        <a
          ...
          className="text-xs text-slate-500 hover:text-red-400 transition-colors hover:cursor-pointer"
        >
          Forgot password?
        </a>
      </div>
